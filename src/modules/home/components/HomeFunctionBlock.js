...
class HomeFunctionBlock extends React.PureComponent {
  ...
  render() {
    ...
    const data = [{
        ...
        icon:'./assets/img/i_1.png',
        text: `分类`,
      }, {
        icon: `./assets/img/i_2.png`,
        text: `购物车`,
      }, {
        icon: `./assets/img/i_3.png`,
        text: `关注商品`,
      }, {
        icon: `./assets/img/i_4.png`,
        text: `关注店铺`,
      }, {
        icon: `./assets/img/i_5.png`,
        text: `浏览记录`,
      }, {
        icon: `./assets/img/i_6.png`,
        text: `退换货`,
      }, {
        icon: `./assets/img/i_7.png`,
        text: `积分`,
      }, {
        icon: `./assets/img/i_8.png`,
        text: `优惠券`,
      },
      {
